...
def test_cost_report_muestra_modelos_y_total():
    ...
    assert "qwen3.8-flash" in rep
    assert "$0.0033" in rep   # 5000/1e6*0.25 + 2000/1e6*1.00 (deepseek-v4-flash)
    assert "$0.0032" in rep   # 12000/1e6*0.15 + 3000/1e6*0.47 (qwen3.8-flash)
    assert "TOTAL" in rep
